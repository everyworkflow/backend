...
class IndexCommand extends Command
{
    ...
    {
        $this->setDescription('Generates indexer index')
            ->setHelp('Eg: bin/console indexer:index' . PHP_EOL
                . 'Eg: bin/console indexer:index -c index_code -f')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $this->indexerList->index($indexCodes, $isForced);
        } catch (\Exception $e) {
