...
#[AsCommand(name: 'indexer:invalid')]
class InvalidCommand extends Command
{
    ...
    {
        $this->setDescription('Invalid indexer index')
            ->setHelp('Eg: bin/console indexer:invalid' . PHP_EOL
                . 'Eg: bin/console indexer:invalid -c index_code -f')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $this->indexerList->invalid($indexCodes, $isForced);
        } catch (\Exception $e) {
