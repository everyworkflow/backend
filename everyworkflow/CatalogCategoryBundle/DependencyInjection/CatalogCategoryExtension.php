...
namespace EveryWorkflow\CatalogCategoryBundle\DependencyInjection;
...
class CatalogCategoryExtension extends Extension implements PrependExtensionInterface
{
    /**
     * @throws \Exception
     *
