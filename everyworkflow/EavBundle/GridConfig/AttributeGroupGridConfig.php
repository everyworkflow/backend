...
class AttributeGroupGridConfig extends DataGridConfig implements AttributeGroupGridConfigInterface
{
    ...
    {
        return array_merge(
            ['_id', 'entity_code', 'code', 'name', 'status', 'created_at', 'updated_at'],
    ...
    public function getHeaderActions(): array
    {
        return array_merge([
            $this->getActionFactory()->create(ButtonHeaderAction::class, [
                ...
                'button_path' => '/system/attribute-group/create',
                'button_type' => 'primary',
            ]),
    ...
    public function getRowActions(): array
    {
        return array_merge([
            $this->getActionFactory()->create(ButtonRowAction::class, [
                'button_label' => 'Edit',
                'button_path' => '/system/attribute-group/{code}/edit',
                'button_type' => 'primary',
            ]),
            $this->getActionFactory()->create(ButtonRowAction::class, [
                'button_label' => 'Delete',
                'button_path' => '/eav/attribute-group/{code}',
                'button_type' => 'primary',
    ...
    public function getBulkActions(): array
    {
        $bulkActions = [
            $this->getActionFactory()->create(ButtonBulkAction::class, [
                'button_label' => 'Enable',
                'button_path' => '/eav/attribute-group/bulk-action/enable',
                'button_type' => 'default',
                'path_type' => ButtonBulkAction::PATH_TYPE_POST_CALL,
            ]),
            $this->getActionFactory()->create(ButtonBulkAction::class, [
                'button_label' => 'Disable',
                'button_path' => '/eav/attribute-group/bulk-action/disable',
                'button_type' => 'default',
                'path_type' => ButtonBulkAction::PATH_TYPE_POST_CALL,
            ]),
        ];
